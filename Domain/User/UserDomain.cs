...
namespace Api.Domain
{
    public class UserDomain : BaseDomain, IUserDomain
    {
        ...
        public DTOResponse<DTOUser> AdminLogin(DTOInfo loginInfo)
        {
            ...
            if (existingUser.AccessLevel != UserAccessLevel.Admin)
            {
                return new DTOResponse<DTOUser>()
                {
                    Code = 401,
                    Message = "This user dont have the required Access Level!"
                };
            }
        ...
        public DTOResponse<bool> SendVerificationCode(string userEmail)
        {
            ...
            _emailSender.Send(userEmail, "Helpet Group - Here is your code", verificationCode);
        ...
        {
            var getUserPetsResponse = _petDomain.GetPetsByUserId(dtoUser.Id);
            if (getUserPetsResponse.Code == 200)
            {
                dtoUser.Pets = getUserPetsResponse.Data;
            }
        }
        #endregion
    }
